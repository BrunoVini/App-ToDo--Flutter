...
class _TodoListState extends State<TodoList> {
  ...
  final _doneStyle = TextStyle(
      color: Colors.green[900], decoration: TextDecoration.lineThrough);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.green, title: Text('Todo App')),
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () => _showAlertDialog(context,
                      'Gostaria de excluir este item?', _removeItem, index),
                ),
                Visibility(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () => _showAlertDialog(
                          context,
                          'Gostaria de marcar este item como concluido?',
                          _doneItem,
                          index),
                    ))
              ],
